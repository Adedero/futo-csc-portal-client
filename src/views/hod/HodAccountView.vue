...
async function getStaffAccount() {
    try {
        const res = await fetch(`${import.meta.env.VITE_API}/hod/account-details`, { credentials: 'include' });
...
async function uploadPicture() {
    ...
    try {
        ...
        // Send URL to backend
        const res = await fetch(`${import.meta.env.VITE_API}/hod/upload-picture`, {
            method: 'PUT',
            credentials: 'include',
            headers: {
...
async function changeUsername() {
    ...
    try {
        const res = await fetch(`${import.meta.env.VITE_API}/hod/change-username?username=${account.value.username}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function updateProfile() {
    ...
    try {
        const res = await fetch(`${import.meta.env.VITE_API}/hod/update-profile?staffId=${account.value.staff._id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function changePassword() {
    ...
    try {
        const res = await fetch(`${import.meta.env.VITE_API}/hod/change-password`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
                            ...
                            <Fieldset>
                                ...
                                <div class="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
                                    ...
                                    <div>
                                        ...
                                        <InputText value="H.O.D" class="w-full" />
                                    </div>
