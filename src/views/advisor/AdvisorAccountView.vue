...
async function getStaffAccount() {
    try {
        const res = await fetch(`${import.meta.env.VITE_API}/advisor/account-details`, { credentials: 'include' });
...
async function uploadPicture() {
    ...
    try {
        ...
        // Send URL to backend
        const res = await fetch(`${ import.meta.env.VITE_API }/advisor/upload-picture`, {
            method: 'PUT',
            credentials: 'include',
            headers: {
...
async function changeUsername() {
    ...
    try {
        const res = await fetch(`${import.meta.env.VITE_API}/advisor/change-username?username=${account.value.username}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function updateProfile() {
    ...
    try {
        const res = await fetch(`${import.meta.env.VITE_API}/advisor/update-profile?staffId=${account.value.staff._id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function changePassword() {
    ...
    try {
        const res = await fetch(`${import.meta.env.VITE_API}/advisor/change-password`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
